...
# 然后本地浏览器打开 http://tao93.top/ 开始设置 WordPress
...
# copy files in public to server's directory, therefore updated pages can be browsed at http://tao93.top/ 
```
...
if len(sys.argv) == 1:
    ...
    if isinstance(im, Image.Image):
        ...
        url = 'https://tao93.top/images/' + date_path + '/' + f_name
